...
onready var player = $ARVRCamera
onready var gui = $ARVRLeftController/MeshInstance/Viewport/DebugGUI
...
func _on_input_focus_gained():
    $ARVRLeftController.show()
    $ARVRRightController.show()
    print("Input focus gained")


func _on_input_focus_lost():
    $ARVRLeftController.hide()
    $ARVRRightController.hide()
